...
export default function TopAppBar() {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between px-10 ml-[260px] w-[calc(100%-260px)] h-20 bg-white/80 backdrop-blur-3xl border-b border-zinc-200/50 shadow-sm">
      ...
      <div className="flex items-center gap-6">
        <button className="relative text-zinc-400 hover:text-zinc-900 transition-colors duration-300 flex items-center group">
        ...
        <button className="text-zinc-400 hover:text-zinc-900 transition-colors duration-300 flex items-center group">
          <span className="material-symbols-outlined group-hover:scale-110 transition-transform">search</span>
        </button>
        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white shadow-sm ml-2 cursor-pointer hover:scale-105 transition-transform">
